 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientWriterInterface< ::mosaic::ImageAndTextChunk>> ProcessImageAndText(::grpc::ClientContext* context, ::mosaic::TextResponse* response) {
      return std::unique_ptr< ::grpc::ClientWriterInterface< ::mosaic::ImageAndTextChunk>>(ProcessImageAndTextRaw(context, response));
    }
    std::unique_ptr< ::grpc::ClientAsyncWriterInterface< ::mosaic::ImageAndTextChunk>> AsyncProcessImageAndText(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncWriterInterface< ::mosaic::ImageAndTextChunk>>(AsyncProcessImageAndTextRaw(context, response, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientAsyncWriterInterface< ::mosaic::ImageAndTextChunk>> PrepareAsyncProcessImageAndText(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncWriterInterface< ::mosaic::ImageAndTextChunk>>(PrepareAsyncProcessImageAndTextRaw(context, response, cq));
    }
    std::unique_ptr< ::grpc::ClientWriterInterface< ::mosaic::ImageAndTextChunk>> TrainModel(::grpc::ClientContext* context, ::mosaic::TextResponse* response) {
      return std::unique_ptr< ::grpc::ClientWriterInterface< ::mosaic::ImageAndTextChunk>>(TrainModelRaw(context, response));
    }
    std::unique_ptr< ::grpc::ClientAsyncWriterInterface< ::mosaic::ImageAndTextChunk>> AsyncTrainModel(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncWriterInterface< ::mosaic::ImageAndTextChunk>>(AsyncTrainModelRaw(context, response, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientAsyncWriterInterface< ::mosaic::ImageAndTextChunk>> PrepareAsyncTrainModel(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncWriterInterface< ::mosaic::ImageAndTextChunk>>(PrepareAsyncTrainModelRaw(context, response, cq));
    }
    ...
    class async_interface {
     public:
      ...
      virtual void ProcessImageAndText(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::ClientWriteReactor< ::mosaic::ImageAndTextChunk>* reactor) = 0;
      virtual void TrainModel(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::ClientWriteReactor< ::mosaic::ImageAndTextChunk>* reactor) = 0;
   ...
   private:
    virtual ::grpc::ClientWriterInterface< ::mosaic::ImageAndTextChunk>* ProcessImageAndTextRaw(::grpc::ClientContext* context, ::mosaic::TextResponse* response) = 0;
    virtual ::grpc::ClientAsyncWriterInterface< ::mosaic::ImageAndTextChunk>* AsyncProcessImageAndTextRaw(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::CompletionQueue* cq, void* tag) = 0;
    virtual ::grpc::ClientAsyncWriterInterface< ::mosaic::ImageAndTextChunk>* PrepareAsyncProcessImageAndTextRaw(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientWriterInterface< ::mosaic::ImageAndTextChunk>* TrainModelRaw(::grpc::ClientContext* context, ::mosaic::TextResponse* response) = 0;
    virtual ::grpc::ClientAsyncWriterInterface< ::mosaic::ImageAndTextChunk>* AsyncTrainModelRaw(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::CompletionQueue* cq, void* tag) = 0;
    virtual ::grpc::ClientAsyncWriterInterface< ::mosaic::ImageAndTextChunk>* PrepareAsyncTrainModelRaw(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::CompletionQueue* cq) = 0;
  ...
  class Stub final : public StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientWriter< ::mosaic::ImageAndTextChunk>> ProcessImageAndText(::grpc::ClientContext* context, ::mosaic::TextResponse* response) {
      return std::unique_ptr< ::grpc::ClientWriter< ::mosaic::ImageAndTextChunk>>(ProcessImageAndTextRaw(context, response));
    }
    std::unique_ptr< ::grpc::ClientAsyncWriter< ::mosaic::ImageAndTextChunk>> AsyncProcessImageAndText(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncWriter< ::mosaic::ImageAndTextChunk>>(AsyncProcessImageAndTextRaw(context, response, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientAsyncWriter< ::mosaic::ImageAndTextChunk>> PrepareAsyncProcessImageAndText(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncWriter< ::mosaic::ImageAndTextChunk>>(PrepareAsyncProcessImageAndTextRaw(context, response, cq));
    }
    std::unique_ptr< ::grpc::ClientWriter< ::mosaic::ImageAndTextChunk>> TrainModel(::grpc::ClientContext* context, ::mosaic::TextResponse* response) {
      return std::unique_ptr< ::grpc::ClientWriter< ::mosaic::ImageAndTextChunk>>(TrainModelRaw(context, response));
    }
    std::unique_ptr< ::grpc::ClientAsyncWriter< ::mosaic::ImageAndTextChunk>> AsyncTrainModel(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncWriter< ::mosaic::ImageAndTextChunk>>(AsyncTrainModelRaw(context, response, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientAsyncWriter< ::mosaic::ImageAndTextChunk>> PrepareAsyncTrainModel(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncWriter< ::mosaic::ImageAndTextChunk>>(PrepareAsyncTrainModelRaw(context, response, cq));
    }
    ...
    class async final :
     ...
     public:
      void ProcessImageAndText(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::ClientWriteReactor< ::mosaic::ImageAndTextChunk>* reactor) override;
      void TrainModel(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::ClientWriteReactor< ::mosaic::ImageAndTextChunk>* reactor) override;
   ...
   private:
    ...
    ::grpc::ClientWriter< ::mosaic::ImageAndTextChunk>* ProcessImageAndTextRaw(::grpc::ClientContext* context, ::mosaic::TextResponse* response) override;
    ::grpc::ClientAsyncWriter< ::mosaic::ImageAndTextChunk>* AsyncProcessImageAndTextRaw(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::CompletionQueue* cq, void* tag) override;
    ::grpc::ClientAsyncWriter< ::mosaic::ImageAndTextChunk>* PrepareAsyncProcessImageAndTextRaw(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientWriter< ::mosaic::ImageAndTextChunk>* TrainModelRaw(::grpc::ClientContext* context, ::mosaic::TextResponse* response) override;
    ::grpc::ClientAsyncWriter< ::mosaic::ImageAndTextChunk>* AsyncTrainModelRaw(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::CompletionQueue* cq, void* tag) override;
    ::grpc::ClientAsyncWriter< ::mosaic::ImageAndTextChunk>* PrepareAsyncTrainModelRaw(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    Service();
    virtual ~Service();
    virtual ::grpc::Status ProcessImageAndText(::grpc::ServerContext* context, ::grpc::ServerReader< ::mosaic::ImageAndTextChunk>* reader, ::mosaic::TextResponse* response);
    virtual ::grpc::Status TrainModel(::grpc::ServerContext* context, ::grpc::ServerReader< ::mosaic::ImageAndTextChunk>* reader, ::mosaic::TextResponse* response);
  ...
  class WithAsyncMethod_ProcessImageAndText : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status ProcessImageAndText(::grpc::ServerContext* /*context*/, ::grpc::ServerReader< ::mosaic::ImageAndTextChunk>* /*reader*/, ::mosaic::TextResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestProcessImageAndText(::grpc::ServerContext* context, ::grpc::ServerAsyncReader< ::mosaic::TextResponse, ::mosaic::ImageAndTextChunk>* reader, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  class WithAsyncMethod_TrainModel : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status TrainModel(::grpc::ServerContext* /*context*/, ::grpc::ServerReader< ::mosaic::ImageAndTextChunk>* /*reader*/, ::mosaic::TextResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestTrainModel(::grpc::ServerContext* context, ::grpc::ServerAsyncReader< ::mosaic::TextResponse, ::mosaic::ImageAndTextChunk>* reader, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  typedef WithAsyncMethod_ProcessImageAndText<WithAsyncMethod_TrainModel<WithAsyncMethod_SendModelStream<WithAsyncMethod_SendIntValue<WithAsyncMethod_ReceiveModelStream<Service > > > > > AsyncService;
  template <class BaseClass>
   ...
   public:
    WithCallbackMethod_ProcessImageAndText() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackClientStreamingHandler< ::mosaic::ImageAndTextChunk, ::mosaic::TextResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, ::mosaic::TextResponse* response) { return this->ProcessImageAndText(context, response); }));
    }
    ...
    virtual ::grpc::ServerReadReactor< ::mosaic::ImageAndTextChunk>* ProcessImageAndText(
      ::grpc::CallbackServerContext* /*context*/, ::mosaic::TextResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
   ...
   public:
    WithCallbackMethod_TrainModel() {
      ::grpc::Service::MarkMethodCallback(1,
          new ::grpc::internal::CallbackClientStreamingHandler< ::mosaic::ImageAndTextChunk, ::mosaic::TextResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, ::mosaic::TextResponse* response) { return this->TrainModel(context, response); }));
    }
    ...
    virtual ::grpc::ServerReadReactor< ::mosaic::ImageAndTextChunk>* TrainModel(
      ::grpc::CallbackServerContext* /*context*/, ::mosaic::TextResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_ProcessImageAndText<WithCallbackMethod_TrainModel<WithCallbackMethod_SendModelStream<WithCallbackMethod_SendIntValue<WithCallbackMethod_ReceiveModelStream<Service > > > > > CallbackService;
  ...
  class WithRawMethod_ProcessImageAndText : public BaseClass {
   ...
   public:
    ...
    void RequestProcessImageAndText(::grpc::ServerContext* context, ::grpc::ServerAsyncReader< ::grpc::ByteBuffer, ::grpc::ByteBuffer>* reader, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncClientStreaming(0, context, reader, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithRawMethod_TrainModel : public BaseClass {
   ...
   public:
    ...
    void RequestTrainModel(::grpc::ServerContext* context, ::grpc::ServerAsyncReader< ::grpc::ByteBuffer, ::grpc::ByteBuffer>* reader, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncClientStreaming(1, context, reader, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  ...
  class WithRawCallbackMethod_ProcessImageAndText : public BaseClass {
   ...
   public:
    WithRawCallbackMethod_ProcessImageAndText() {
      ::grpc::Service::MarkMethodRawCallback(0,
          new ::grpc::internal::CallbackClientStreamingHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, ::grpc::ByteBuffer* response) { return this->ProcessImageAndText(context, response); }));
    }
    ...
    virtual ::grpc::ServerReadReactor< ::grpc::ByteBuffer>* ProcessImageAndText(
   ...
   public:
    WithRawCallbackMethod_TrainModel() {
      ::grpc::Service::MarkMethodRawCallback(1,
          new ::grpc::internal::CallbackClientStreamingHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, ::grpc::ByteBuffer* response) { return this->TrainModel(context, response); }));
    }
    ...
    virtual ::grpc::ServerReadReactor< ::grpc::ByteBuffer>* TrainModel(
      ::grpc::CallbackServerContext* /*context*/, ::grpc::ByteBuffer* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_SendIntValue<Service > StreamedUnaryService;
  template <class BaseClass>
  ...
  typedef WithSplitStreamingMethod_SendModelStream<WithStreamedUnaryMethod_SendIntValue<Service > > StreamedService;
};
