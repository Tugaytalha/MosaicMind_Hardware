...
class ImageAndTextChunk final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mosaic.ImageAndTextChunk) */ {
 public:
  inline ImageAndTextChunk() : ImageAndTextChunk(nullptr) {}
  ~ImageAndTextChunk() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR ImageAndTextChunk(::google::protobuf::internal::ConstantInitialized);

  inline ImageAndTextChunk(const ImageAndTextChunk& from)
      : ImageAndTextChunk(nullptr, from) {}
  ImageAndTextChunk(ImageAndTextChunk&& from) noexcept
    : ImageAndTextChunk() {
    *this = ::std::move(from);
  }
  ...
  friend void swap(ImageAndTextChunk& a, ImageAndTextChunk& b) {
    a.Swap(&b);
  }
  ...
  ImageAndTextChunk* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ImageAndTextChunk>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const ImageAndTextChunk& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom( const ImageAndTextChunk& from) {
    ImageAndTextChunk::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg);
  public:
  ...
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "mosaic.ImageAndTextChunk";
  }
  protected:
