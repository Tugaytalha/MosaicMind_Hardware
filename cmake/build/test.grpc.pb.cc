...
YourService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  : channel_(channel), rpcmethod_ProcessImageAndText_(YourService_method_names[0], options.suffix_for_stats(),::grpc::internal::RpcMethod::CLIENT_STREAMING, channel)
  , rpcmethod_TrainModel_(YourService_method_names[1], options.suffix_for_stats(),::grpc::internal::RpcMethod::CLIENT_STREAMING, channel)
  , rpcmethod_SendModelStream_(YourService_method_names[2], options.suffix_for_stats(),::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
...
::grpc::ClientWriter< ::mosaic::ImageAndTextChunk>* YourService::Stub::ProcessImageAndTextRaw(::grpc::ClientContext* context, ::mosaic::TextResponse* response) {
...
void YourService::Stub::async::ProcessImageAndText(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::ClientWriteReactor< ::mosaic::ImageAndTextChunk>* reactor) {
...
::grpc::ClientAsyncWriter< ::mosaic::ImageAndTextChunk>* YourService::Stub::AsyncProcessImageAndTextRaw(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::CompletionQueue* cq, void* tag) {
...
::grpc::ClientAsyncWriter< ::mosaic::ImageAndTextChunk>* YourService::Stub::PrepareAsyncProcessImageAndTextRaw(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::CompletionQueue* cq) {
...
::grpc::ClientWriter< ::mosaic::ImageAndTextChunk>* YourService::Stub::TrainModelRaw(::grpc::ClientContext* context, ::mosaic::TextResponse* response) {
...
void YourService::Stub::async::TrainModel(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::ClientWriteReactor< ::mosaic::ImageAndTextChunk>* reactor) {
...
::grpc::ClientAsyncWriter< ::mosaic::ImageAndTextChunk>* YourService::Stub::AsyncTrainModelRaw(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::CompletionQueue* cq, void* tag) {
...
::grpc::ClientAsyncWriter< ::mosaic::ImageAndTextChunk>* YourService::Stub::PrepareAsyncTrainModelRaw(::grpc::ClientContext* context, ::mosaic::TextResponse* response, ::grpc::CompletionQueue* cq) {
...
YourService::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::ClientStreamingHandler< YourService::Service, ::mosaic::ImageAndTextChunk, ::mosaic::TextResponse>(
          [](YourService::Service* service,
...
::grpc::Status YourService::Service::ProcessImageAndText(::grpc::ServerContext* context, ::grpc::ServerReader< ::mosaic::ImageAndTextChunk>* reader, ::mosaic::TextResponse* response) {
  (void) context;
  (void) reader;
  (void) response;
...
::grpc::Status YourService::Service::TrainModel(::grpc::ServerContext* context, ::grpc::ServerReader< ::mosaic::ImageAndTextChunk>* reader, ::mosaic::TextResponse* response) {
  (void) context;
  (void) reader;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
